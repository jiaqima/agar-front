(function(f, l) {
    ...
    function Ta() {
        ...
        f.onkeydown = function(d) {
            ...
            27 == d.keyCode && Ea(!0)
            if(d.keyCode==13||d.keyCode==108){
                if(chat_text.innerHTML==""){
                    chat_text.innerHTML=chat_text.innerHTML+"<input type='text' name='text' id='my_t' style='position:relative;left:100;right:120;top:100;bottom:120;z-index:20;background-color:rgba(0,0,0,0.5);'>";
